...
func AddServer(elem map[string]string) (err error) {
	...
	for z, v := range jsonData {
		...
		if err != nil {
			logs.Error("ERROR stap/AddServer INSERT default server: " + err.Error())
			return err
		}
	}
...
func GetAllServers() (data map[string]map[string]string, err error) {
	...
	if err != nil {
		logs.Error("ERROR stap/GetAllServers: " + err.Error())
		return nil, err
	}
...
func GetServer(serveruuid string) (data map[string]map[string]string, err error) {
	...
	if err != nil {
		logs.Error("ERROR stap/GetServer: " + err.Error())
		return nil, err
	}
	return server, nil
}
...
func RunStap(uuid string) (data string, err error) {
	...
	if err != nil {
		logs.Error("ERROR stap/RunStap: " + err.Error())
		return "", err
	}
...
func StopStap(uuid string) (data string, err error) {
	...
	if err != nil {
		logs.Error("ERROR stap/StopStap: " + err.Error())
		return "", err
	}
...
func RunStapServer(serveruuid string) (data string, err error) {
	...
	if err != nil {
		logs.Error("ERROR stap/RunStapServer: " + err.Error())
		return "", err
	}
...
func StopStapServer(serveruuid string) (data string, err error) {
	...
	if err != nil {
		logs.Error("ERROR stap/StopStapServer: " + err.Error())
		return "", err
	}
...
func ErrorStapServer(serveruuid string) (data string, err error) {
	...
	if err != nil {
		logs.Error("ERROR stap/ErrorStapServer: " + err.Error())
		return "", err
	}
...
func PingServerStap(server string) (isIt map[string]string, err error) {
	...
	if err != nil {
		logs.Error("ERROR stap/PingServerStap: " + err.Error())
		return nil, err
	}
...
func DeleteStapServer(serveruuid string) (data string, err error) {
	...
	if err != nil {
		logs.Error("ERROR stap/DeleteStapServer: " + err.Error())
		return "", err
	}
...
func EditStapServer(data map[string]string) (err error) {
	...
	if err != nil {
		logs.Error("ERROR stap/EditStapServer: " + err.Error())
		return err
	}
