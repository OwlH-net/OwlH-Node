...
func PingPorts() (data map[string]map[string]string ,err error) {
    ...
    if err != nil {logs.Error("PingPorts knownports Error : %s", err.Error()); return nil, err}
    return plugins, nil
}
...
func ShowPorts() (data map[string]map[string]string, err error) {
    ...
    if err != nil {logs.Error("ShowPorts knownports Error : %s", err.Error()); return nil, err}
    return ports, nil
}
...
func ChangeStatus(anode map[string]string) (err error) {
    ...
    if err != nil {logs.Error("ChangeStatus knownports Error : %s", err.Error()); return err}
    return nil
}

func ChangeMode(anode map[string]string) (err error) {
    err = ndb.UpdatePluginValue(anode["mode"], "mode", "knownports")
    if err != nil {logs.Error("ChangeMode knownports Error : %s", err.Error()); return err}
    return nil
}

func DeletePorts(ports map[string]string) (err error) {
    err = ndb.DeletePort(ports)
    if err != nil {logs.Error("DeletePorts knownports Error : %s", err.Error()); return err}
...
func DeleteAllPorts() (err error) {
    ...
    if err != nil {logs.Error("DeleteAllPorts knownports Error : %s", err.Error()); return err}
